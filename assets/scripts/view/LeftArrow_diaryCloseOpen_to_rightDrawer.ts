...
@ccclass("LeftArrow_diaryCloseOpen_to_rightDrawer")
export class RightArrow extends Component {
    private readonly interactableId = "point_leftArrow_diaryCloseOpen_to_rightDrawer";
    ...
    private onTriggered(result: any) {
        ...
        switch (result?.code) {
            case "ENTER_RIGHTDRAWER":
                console.log("[LeftArrow] 触发 ENTER_DRAWER -> 返回右抽屉特写");
                return;
        }
    }
}
