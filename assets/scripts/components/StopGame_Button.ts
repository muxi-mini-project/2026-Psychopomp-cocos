...
@ccclass('StopGame_Button')
export class StopGame_Button extends Component {
    ...
    onLoad() {
        ...
        this.node.on('click', this.onStopClick, this)
    }
    ...
    onDestroy() {
        ...
        this.node.off('click', this.onStopClick, this)
    }
}
